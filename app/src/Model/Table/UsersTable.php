...
class UsersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->maxLength('username', 10, 'ユーザー名は10字以内で入力してください')
            ->add('username', 'alphaNumeric', [
                'rule' => function ($value) {
                    $pattern = '/\A[a-zA-Z0-9]+\z/';
                    return (bool)preg_match($pattern, $value);
                },
                'message' => 'ユーザー名は半角英数字のみで入力してください'
            ])
            ->add('username', 'unique', [
                'rule' => 'validateUnique',
                'provider' => 'table',
        ...
        $validator
            ...
            ->lengthBetween('password', [8, 16], 'パスワードは8字以上16文字以内で入力してください')
